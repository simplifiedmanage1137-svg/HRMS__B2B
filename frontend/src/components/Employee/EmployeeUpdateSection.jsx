...
const EmployeeUpdateSection = () => {
  ...
  const fetchPendingRequests = async () => {
    try {
      const response = await axios.get(
        `https://employee-management-system-1-qs2v.onrender.com//api/admin-updates/employee-requests/${user.employeeId}`
      );
  ...
  const fetchCurrentEmployeeData = async () => {
    try {
      const response = await axios.get(
        `https://employee-management-system-1-qs2v.onrender.com//api/employees/profile/${user.employeeId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://employee-management-system-1-qs2v.onrender.com//api/admin-updates/submit-update', {
