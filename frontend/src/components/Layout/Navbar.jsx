...
const Navbar = () => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      const response = await axios.get(`https://employee-management-system-1-qs2v.onrender.com//api/notifications?employee_id=${user.employeeId}`);
  ...
  const markAsRead = async (id) => {
    try {
      await axios.put(`https://employee-management-system-1-qs2v.onrender.com//api/notifications/${id}/read`);
  ...
  const deleteNotification = async (id, e) => {
    ...
    try {
      ...
      await axios.delete(`https://employee-management-system-1-qs2v.onrender.com//api/notifications/${id}`);
